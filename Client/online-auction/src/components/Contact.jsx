        ...
        <div className="h-full w-full flex flex-col items-center font-serif mx-7">
            ...
            <div className="grid sm:grid-cols-2 items-start gap-14 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
                    ...
                    <div className="mt-12">
                        ...
                        <ul className="mt-4">
                            <li className="flex items-center">
                                ...
                                <a href="javascript:void(0)" className="text-blue-500 text-sm ml-4">
                                    <small className="block">Mail</small>
                                    <strong>boopathikannan.com</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <form className="ml-auo space-y-4 w-96">
                    ...
                    <button type='button'
                        className="text-white bg-black hover:bg-yelow-600 rounded-md text-sm px-4 py-3 w-full !mt-6">Send</button>
                </form>
            </div>
        </div>
